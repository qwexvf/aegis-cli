...
func runTaintAnalysis(root *ts.Node, src []byte, path string, f *ast.Findings) {
...
func checkConstantFolding(root *ts.Node, src []byte, path string, f *ast.Findings, tab map[string]jsVar) {
...
func checkTaintedSinks(_ *ts.Node, src []byte, path string, f *ast.Findings, tab map[string]jsVar) {
