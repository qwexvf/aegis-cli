// Package py implements ast.LanguageScanner for Python using
// tree-sitter with the tree-sitter-python grammar. Detection patterns
// mirror the JS scanner's design — see js/queries.scm for the
...
//
// Coverage today (mirrors js capability set):
//
